...
public class TwitterBot {
    ...
    public TwitterBot(BufferedReader br, int tweetColumn, NumberGenerator ng) {
        ...
        this.ng = ng;
        List<List<String>> tweets = TweetParser.csvDataToTrainingData(br, tweetColumn);
    ...
    public void writeStringsToFile(
        ...
        try {
            ...
            bw = new BufferedWriter(fileReader);
        ...
        for (int i = 0; i < numWords; i++) {
           // System.out.println(i);
                if (mc.hasNext()) {
                    ...
                    if(mc.hasNext()){
                        System.out.println("MC HAS NEXT");
                        tweetString.append(word + " ");
                    }
                    else{
                        System.out.println("MC JUST GOT LAST WORD");
                        tweetString.append(word);
                    }
                } else {
                    String punctuation = randomPunctuation();
                    //System.out.println("PUNCUATION: " + punctuation);
                    tweetString.append(punctuation + " ");
                    mc.reset();
                    i -= 1;
                }
                //break;
            }
        tweetString.append(randomPunctuation());
